...
var Options = /*#__PURE__*/function () {
  ...
  _createClass(Options, [{
    ...
    value: function storeCookie() {
      ...
      document.cookie = "fullname=".concat(this.name, ";expires=").concat(expires, ";");
...
undefined = 'Asia/Manila';
var user = new _options.default();

var AgeCounter = /*#__PURE__*/function () {
  function AgeCounter(date) {
  ...
  _createClass(AgeCounter, [{
    ...
    value: function count() {
      ...
      return (this.to - Date.parse(this.from)) / day / 365.2425;
    }
  }]);
...
var LiveCount = /*#__PURE__*/function () {
  ...
  _createClass(LiveCount, [{
    ...
    key: "dateInterval",
    value: function dateInterval(from, to, decimalCount) {
      this.element.innerHTML = new AgeCounter({
        from: from,
        to: to
...
var nickname_container = DOMElements.nickname_container,
    ...
    options_tab = DOMElements.options_tab,
...
},{"../options.js":"options.js","luxon":"node_modules/luxon/build/cjs-browser/luxon.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
